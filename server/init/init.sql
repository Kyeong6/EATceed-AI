...
(
    ...
    SUMMARIZED_ADVICE text NOT NULL,
...
CREATE TABLE DIET_ANALYSIS_TB
(
    DIET_ANALYSIS_PK bigint(20) NOT NULL AUTO_INCREMENT,
    EAT_HABITS_FK bigint(20) DEFAULT NULL,
    NUTRIENT_ANALYSIS text NOT NULL,
    DIET_IMPROVE  text NOT NULL,
    CUSTOM_RECOMMEND  text NOT NULL,
    PRIMARY KEY (DIET_ANALYSIS_PK),
    FOREIGN KEY (EAT_HABITS_FK) REFERENCES EAT_HABITS_TB (EAT_HABITS_PK) ON DELETE CASCADE
) ENGINE = InnoDB;
